...
insert into Livro(isbn,nome,fk_autor_id,ano_publicacao,editora,quantidade,imagem) values('9780132350884','Clean Code', 1, '2008', 'Editora Exemplo', 30, 'https://covers.openlibrary.org/b/id/8085499-M.jpg');
insert into Livro(isbn,nome,fk_autor_id,ano_publicacao,editora,quantidade,imagem) values('9780007459483','Game Of Thrones', 1, '2011', 'HarperCollins Publishers', 50, 'https://covers.openlibrary.org/b/id/8753464-M.jpg');
insert into Livro(isbn,nome,fk_autor_id,ano_publicacao,editora,quantidade,imagem) values('9780747532743','Harry Potter', 1, '1999', 'Bloomsbury', 224, 'https://covers.openlibrary.org/b/id/10580372-M.jpg');
